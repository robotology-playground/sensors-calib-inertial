classdef SensorDataYarpI < handle
    ...
    methods(Access = public)
        function obj = SensorDataYarpI(robotEnvNames,dataFolderPath)
            ...
            obj.robotEnvNames = robotEnvNames;
    ...
    methods(Access = protected)
        ...
        function buildSensType2portNgetter(obj)
            ...
            sensorType = {...
                'joint_from','acc_from','gyro8_from','gyro9_from','imu_from','xsens_from','fts_from','jtorq_from','curr_from',...
                'joint_to','acc_to','gyro8_to','gyro9_to','imu_to','xsens_to','fts_to','jtorq_to','curr_to',...
                'joint_path','acc_path','gyro8_path','gyro9_path','imu_path','xsens_path','fts_path','jtorq_path','curr_path'};
            portNamingRule = {...
                eval(['@(robotYarpPortPrefix,part)' joints_port_rule_icub]),...
                eval(['@(robotYarpPortPrefix,part)' accSensors_port_rule_icub]),...
                eval(['@(robotYarpPortPrefix,part)' gyro8Sensors_port_rule_icub]),...
                eval(['@(robotYarpPortPrefix,part)' gyro9Sensors_port_rule_icub]),...
                eval(['@(robotYarpPortPrefix,part)' imuSensors_port_rule_icub]),...
                eval(['@(robotYarpPortPrefix,part)' xsensSensors_port_rule_icub]),...
                eval(['@(robotYarpPortPrefix,part)' FTSensors_port_rule_icub]),...
                eval(['@(robotYarpPortPrefix,part)' joints_port_rule_icub]),...
                eval(['@(robotYarpPortPrefix,part)' joints_port_rule_icub]),...
                eval(['@(robotYarpPortPrefix,part)' joints_port_rule_dumper]),...
                eval(['@(robotYarpPortPrefix,part)' accSensors_port_rule_dumper]),...
                eval(['@(robotYarpPortPrefix,part)' gyro8Sensors_port_rule_dumper]),...
                eval(['@(robotYarpPortPrefix,part)' gyro9Sensors_port_rule_dumper]),...
                eval(['@(robotYarpPortPrefix,part)' imuSensors_port_rule_dumper]),...
                eval(['@(robotYarpPortPrefix,part)' xsensSensors_port_rule_dumper]),...
                eval(['@(robotYarpPortPrefix,part)' FTSensors_port_rule_dumper]),...
                eval(['@(robotYarpPortPrefix,part)' joints_port_rule_dumper]),...
                eval(['@(robotYarpPortPrefix,part)' joints_port_rule_dumper]),...
        ...
        function [newKeyList,newPortList] = newPortEntries(obj,sensor,parts)
            ...
            [newKeyList,newPortList] = cellfun(...
                ...
                portNamingRuleFrom(obj.robotEnvNames.yarpPortPrefix,convert(part)),... % 'from': source port
                portNamingRuleTo(obj.robotEnvNames.yarpPortPrefix,part),...            % 'to'  : sink port
        ...
        function logFolderRelativePath = newDataSubFolderPath(obj,dataLogInfo)
            ...
            logFolderRelativePath = obj.dataLogInfoMap.add(obj.robotEnvNames.modelName,dataLogInfo);
