...
%             disp(init.(obj.initSection).taskSpecificParams.motorName);
%             disp(init.(obj.initSection).taskSpecificParams.frictionOrKtau);
%             disp(init.(obj.initSection).calibedParts);
            disp(obj.state);
