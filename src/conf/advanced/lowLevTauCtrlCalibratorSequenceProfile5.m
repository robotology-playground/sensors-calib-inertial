...
left_arm_seqParams.labels = {...
    'prpt'   ,'mode'   ,'ctrl'               ,'ctrl'          ,'meas'     ,'meas'     ,'meas'     ,'pwmctrl';...
    'NA'     ,'NA'     ,'pos'                ,'vel'           ,'joint'    ,'jtorq'    ,'curr'     ,'pwm'    ;...
    'NA'     ,'NA'     ,'left_arm'           ,'left_arm'      ,'left_arm' ,'left_arm' ,'left_arm' ,motor };
left_arm_seqParams.val = {...
    NA       ,'ctrl'   ,homeCalib.val{1}     ,repmat( 4,[1 7]),false      ,false      ,false      ,0        ;...
    promptStr,'pwmctrl',homeCalib.val{1}     ,repmat( 4,[1 7]),true       ,true       ,true       ,0        };

right_arm_seqParams.labels = {...
    'prpt'   ,'mode'   ,'ctrl'               ,'ctrl'          ,'meas'     ,'meas'     ,'meas'     ,'pwmctrl';...
    'NA'     ,'NA'     ,'pos'                ,'vel'           ,'joint'    ,'jtorq'    ,'curr'     ,'pwm'    ;...
    'NA'     ,'NA'     ,'right_arm'          ,'right_arm'     ,'right_arm','right_arm','right_arm',motor };
...
left_leg_seqParams.val = {...
    ...
    promptStr,'pwmctrl',homeCalib.val{3}     ,repmat( 4,[1 6]),true       ,true       ,true       ,12        ,'triangle',0.1      ;...
    promptStr,'pwmctrl',homeCalib.val{3}     ,repmat( 4,[1 6]),true       ,true       ,true       ,12        ,'triangle',0.3      ;...
    promptStr,'pwmctrl',homeCalib.val{3}     ,repmat( 4,[1 6]),true       ,true       ,true       ,12        ,'triangle',0.6      ;...
    promptStr,'pwmctrl',homeCalib.val{3}     ,repmat( 4,[1 6]),true       ,true       ,true       ,12        ,'triangle',0.9      };
...
torso_seqParams.labels = {...
    'prpt'   ,'mode'   ,'ctrl'               ,'ctrl'          ,'meas'     ,'meas'     ,'meas'     ,'pwmctrl';...
    'NA'     ,'NA'     ,'pos'                ,'vel'           ,'joint'    ,'jtorq'    ,'curr'     ,'pwm'    ;...
    'NA'     ,'NA'     ,'torso'              ,'torso'         ,'torso'    ,'torso'    ,'torso'    ,motor };
torso_seqParams.val = {...
    NA       ,'ctrl'   ,homeCalib.val{5}     ,repmat( 4,[1 3]),false      ,false      ,false      ,0        ;...
    promptStr,'pwmctrl',homeCalib.val{5}     ,repmat( 4,[1 3]),true       ,true       ,true       ,0        };

head_seqParams.labels = {...
    'prpt'   ,'mode'   ,'ctrl'               ,'ctrl'          ,'meas'     ,'meas'     ,'meas'     ,'pwmctrl';...
    'NA'     ,'NA'     ,'pos'                ,'vel'           ,'joint'    ,'jtorq'    ,'curr'     ,'pwm'    ;...
    'NA'     ,'NA'     ,'head'               ,'head'          ,'head'     ,'head'     ,'head'     ,motor };
head_seqParams.val = {...
    NA       ,'ctrl'   ,homeCalib.val{6}     ,repmat( 4,[1 3]),false      ,false      ,false      ,0        ;...
    promptStr,'pwmctrl',homeCalib.val{6}     ,repmat( 4,[1 3]),true       ,true       ,true       ,0        };
