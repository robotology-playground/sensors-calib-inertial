...
obj.maoMTBlabel2offset = containers.Map('KeyType','char','ValueType','any');
for offset = sensorMetaOffsets
    ...
    obj.maoMTBlabel2offset(mtbLabel) = [num2str(1+offset+sensorDataStartOffset) ':' num2str(1+offset+sensorDataStopOffset)];
end
