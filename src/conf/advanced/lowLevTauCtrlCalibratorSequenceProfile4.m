...
left_leg_seqParams.val = {...
    ...
    promptStr,'pwmctrl',homeCalib.val{3}     ,repmat( 4,[1 6]),true       ,true       ,true       ,4         ,'triangle',0.3      ;...
    ...
    promptStr,'pwmctrl',homeCalib.val{3}     ,repmat( 4,[1 6]),true       ,true       ,true       ,16        ,'triangle',0.3      };
