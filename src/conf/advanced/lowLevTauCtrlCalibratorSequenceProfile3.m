...
torso_seqParams.labels = {...
    'prpt'   ,'mode'   ,'ctrl'               ,'ctrl'          ,'meas'     ,'meas'     ,'pwmctrl' ,'pwmctrl' ,'pwmctrl';...
    'NA'     ,'NA'     ,'pos'                ,'vel'           ,'joint'    ,'jtorq'    ,'pwm'     ,'trans'   ,'freq'   ;...
    'NA'     ,'NA'     ,'torso'              ,'torso'         ,'torso'    ,'torso'    ,motor     ,motor     ,motor    };
torso_seqParams.val = {...
    NA       ,'ctrl'   ,homeCalib.val{5}     ,repmat( 4,[1 3]),false      ,false      ,0         ,'level'   ,0        ;...
    promptStr,'pwmctrl',homeCalib.val{5}     ,repmat( 4,[1 3]),true       ,true       ,8         ,'triangle',0.3      };
