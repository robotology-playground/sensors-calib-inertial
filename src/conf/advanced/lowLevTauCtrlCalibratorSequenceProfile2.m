...
left_arm_seqParams.labels = {...
    'mode'   ,'ctrl'               ,'ctrl'          ,'meas'     ,'meas'     ;...
    'NA'     ,'pos'                ,'vel'           ,'joint'    ,'jtorq'    ;...
    'NA'     ,'left_arm'           ,'left_arm'      ,'left_arm' ,'left_arm' };
left_arm_seqParams.val = {...
    'ctrl'   ,homeCalib.val{1}     ,repmat( 4,[1 7]),false      ,false      ;...
    'ctrl'   ,homeCalib.val{1}     ,repmat( 4,[1 7]),true       ,true       };

right_arm_seqParams.labels = {...
    'mode'   ,'ctrl'               ,'ctrl'          ,'meas'     ,'meas'     ;...
    'NA'     ,'pos'                ,'vel'           ,'joint'    ,'jtorq'    ;...
    'NA'     ,'right_arm'          ,'right_arm'     ,'right_arm','right_arm'};
...
left_leg_seqParams.val = {...
    'ctrl'   ,homeCalib.val{3}     ,repmat( 4,[1 6]),false      ,false      ;...
    'ctrl'   ,homeCalib.val{3}     ,repmat( 4,[1 6]),true       ,true       };

right_leg_seqParams.labels = {...
    'mode'   ,'ctrl'               ,'ctrl'          ,'meas'     ,'meas'     ;...
    'NA'     ,'pos'                ,'vel'           ,'joint'    ,'jtorq'    ;...
    'NA'     ,'right_leg'          ,'right_leg'     ,'right_leg','right_leg'};
right_leg_seqParams.val = left_leg_seqParams.val;

torso_seqParams.labels = {...
    'mode'   ,'ctrl'               ,'ctrl'          ,'meas'     ,'meas'     ;...
    'NA'     ,'pos'                ,'vel'           ,'joint'    ,'jtorq'    ;...
    'NA'     ,'torso'              ,'torso'         ,'torso'    ,'torso'    };
torso_seqParams.val = {...
    'ctrl'   ,homeCalib.val{5}     ,repmat( 4,[1 3]),false      ,false      ;...
    'ctrl'   ,homeCalib.val{5}     ,repmat( 4,[1 3]),true       ,true       };

head_seqParams.labels = {...
    'mode'   ,'ctrl'               ,'ctrl'          ,'meas'     ,'meas'     ;...
    'NA'     ,'pos'                ,'vel'           ,'joint'    ,'jtorq'    ;...
    'NA'     ,'head'               ,'head'          ,'head'     ,'head'     };
head_seqParams.val = {...
    'ctrl'   ,homeCalib.val{6}     ,repmat( 4,[1 3]),false      ,false      ;...
    'ctrl'   ,homeCalib.val{6}     ,repmat( 4,[1 3]),true       ,true       };
