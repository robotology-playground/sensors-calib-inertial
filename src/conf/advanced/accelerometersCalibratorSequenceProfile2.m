...
left_leg_seqParams.val = {...
    ...
    NA       ,[-20 90 -60   0   0   0],repmat(6,[1 6]),false      ,false     ;...
    promptStr,[-20 90 -60   0   0   0],repmat(2,[1 6]),true       ,true      ;...
    NA       ,[ 40 90 +60   0   0   0],repmat(6,[1 6]),false      ,false     ;...
    promptStr,[ 40 90 +60   0   0   0],repmat(2,[1 6]),true       ,true      ;...
    NA       ,[-20 90 -60   0   0   0],repmat(6,[1 6]),false      ,false     ;...
    promptStr,[-20 90 -60   0   0   0],repmat(2,[1 6]),true       ,true      ;...
    NA       ,[ 40 90 +60   0   0   0],repmat(6,[1 6]),false      ,false     ;...
    promptStr,[ 40 90 +60   0   0   0],repmat(2,[1 6]),true       ,true      ;...
