...
left_arm_seqParams.labels = {...
    ...
    'NA'     ,'NA'     ,'pos'                ,'vel'           ,'joint'    ,'curr'     ,'trans'   ,'freq'   ;...
    'NA'     ,'NA'     ,'left_arm'           ,'left_arm'      ,'left_arm' ,'left_arm' ,motor     ,motor    };
left_arm_seqParams.val = {...
    NA       ,'ctrl'   ,homeCalib.val{1}     ,repmat( 4,[1 7]),false      ,false      ,'level'   ,0        ;...
    promptStr,'ctrl'   ,homeCalib.val{1}     ,repmat( 4,[1 7]),true       ,true       ,'triangle',0.3      };

right_arm_seqParams.labels = {...
    'prpt'   ,'mode'   ,'ctrl'               ,'ctrl'          ,'meas'     ,'meas'     ,'pwmctrl' ,'pwmctrl';...
    'NA'     ,'NA'     ,'pos'                ,'vel'           ,'joint'    ,'curr'     ,'trans'   ,'freq'   ;...
    'NA'     ,'NA'     ,'right_arm'          ,'right_arm'     ,'right_arm','right_arm',motor     ,motor    };
right_arm_seqParams.val = left_arm_seqParams.val;

left_leg_seqParams.labels = {...
    'prpt'   ,'mode'   ,'ctrl'               ,'ctrl'          ,'meas'     ,'meas'     ,'pwmctrl' ,'pwmctrl','plot'         ;...
    'NA'     ,'NA'     ,'pos'                ,'vel'           ,'joint'    ,'curr'     ,'trans'   ,'freq'   ,'type'         ;...
    'NA'     ,'NA'     ,'left_leg'           ,'left_leg'      ,'left_leg' ,'left_leg' ,motor     ,motor    ,motor          };
left_leg_seqParams.val = {...
    NA       ,'ctrl'   ,homeCalib.val{3}     ,repmat( 4,[1 6]),false      ,false      ,'level'   ,0        ,''             ;...
    promptStr,'ctrl'   ,homeCalib.val{3}     ,repmat( 4,[1 6]),true       ,true       ,'triangle',0.3      ,'motorPwm2Curr'};

right_leg_seqParams.labels = {...
    'prpt'   ,'mode'   ,'ctrl'               ,'ctrl'          ,'meas'     ,'meas'     ,'pwmctrl' ,'pwmctrl','plot'         ;...
    'NA'     ,'NA'     ,'pos'                ,'vel'           ,'joint'    ,'curr'     ,'trans'   ,'freq'   ,'type'         ;...
    'NA'     ,'NA'     ,'right_leg'          ,'right_leg'     ,'right_leg','right_leg',motor     ,motor    ,motor          };
right_leg_seqParams.val = left_leg_seqParams.val;

torso_seqParams.labels = {...
    'prpt'   ,'mode'   ,'ctrl'               ,'ctrl'          ,'meas'     ,'meas'     ,'pwmctrl' ,'pwmctrl';...
    'NA'     ,'NA'     ,'pos'                ,'vel'           ,'joint'    ,'curr'     ,'trans'   ,'freq'   ;...
    'NA'     ,'NA'     ,'torso'              ,'torso'         ,'torso'    ,'torso'    ,motor     ,motor    };
torso_seqParams.val = {...
    NA       ,'ctrl'   ,homeCalib.val{5}     ,repmat( 4,[1 3]),false      ,false      ,'level'   ,0        ;...
    promptStr,'ctrl'   ,homeCalib.val{5}     ,repmat( 4,[1 3]),true       ,true       ,'triangle',0.3      };

head_seqParams.labels = {...
    'prpt'   ,'mode'   ,'ctrl'               ,'ctrl'          ,'meas'     ,'meas'     ,'pwmctrl' ,'pwmctrl';...
    'NA'     ,'NA'     ,'pos'                ,'vel'           ,'joint'    ,'curr'     ,'trans'   ,'freq'   ;...
    'NA'     ,'NA'     ,'head'               ,'head'          ,'head'     ,'head'     ,motor     ,motor    };
head_seqParams.val = {...
    NA       ,'ctrl'   ,homeCalib.val{6}     ,repmat( 4,[1 3]),false      ,false      ,'level'   ,0        ;...
    promptStr,'ctrl'   ,homeCalib.val{6}     ,repmat( 4,[1 3]),true       ,true       ,'triangle',0.3      };
