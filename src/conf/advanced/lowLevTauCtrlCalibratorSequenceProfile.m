...
left_arm_seqParams.labels = {...
    'ctrl'               ,'ctrl'          ,'meas'     ,'meas'     ;...
    'pos'                ,'vel'           ,'joint'    ,'fts'      ;...
    'left_arm'           ,'left_arm'      ,'left_arm' ,'left_arm' };
left_arm_seqParams.val = {...
    homeCalib.val{1}     ,repmat( 4,[1 7]),true       ,true       };

right_arm_seqParams.labels = {...
    'ctrl'               ,'ctrl'          ,'meas'     ,'meas'     ;...
    'pos'                ,'vel'           ,'joint'    ,'fts'      ;...
    'right_arm'          ,'right_arm'     ,'right_arm','right_arm'};
...
left_leg_seqParams.val = {...
    homeCalib.val{3}       ,repmat( 4,[1 6]),true       ,true     };
...
torso_seqParams.val = {...
    homeCalib.val{5}     ,repmat( 4,[1 3]),true       ,true   };
...
head_seqParams.labels = {...
    ...
    'head'               ,'head'          ,'head'     ,'head' };
head_seqParams.val = {...
    homeCalib.val{6}     ,repmat( 4,[1 3]),true       ,true   };
