...
left_leg_seqParams.labels = {...
    'prpt'   ,'mode'   ,'ctrl'               ,'ctrl'          ,'meas'     ,'meas'     ,'pwmctrl' ,'pwmctrl' ,'pwmctrl';...
    'NA'     ,'NA'     ,'pos'                ,'vel'           ,'joint'    ,'jtorq'    ,'pwm'     ,'trans'   ,'freq'   ;...
    'NA'     ,'NA'     ,'left_leg'           ,'left_leg'      ,'left_leg' ,'left_leg' ,motor     ,motor     ,motor    };
left_leg_seqParams.val = {...
    NA       ,'ctrl'   ,homeCalib.val{3}     ,repmat( 4,[1 6]),false      ,false      ,0         ,'level'   ,0        ;...
    promptStr,'pwmctrl',homeCalib.val{3}     ,repmat( 4,[1 6]),true       ,true       ,12        ,'triangle',0.1      ;...
    promptStr,'pwmctrl',homeCalib.val{3}     ,repmat( 4,[1 6]),true       ,true       ,12        ,'triangle',0.3      ;...
    promptStr,'pwmctrl',homeCalib.val{3}     ,repmat( 4,[1 6]),true       ,true       ,12        ,'triangle',0.6      ;...
    promptStr,'pwmctrl',homeCalib.val{3}     ,repmat( 4,[1 6]),true       ,true       ,12        ,'triangle',0.9      };
