classdef SensorDataYarpI < handle
    ...
    methods(Access = protected)
        ...
        function buildSensType2portNgetter(obj)
            ...
            sensorType = {...
                'joint_from','acc_from','imu_from','fts_from','jtorq_from','ftsarms_from',...
                'joint_to','acc_to','imu_to','fts_to','jtorq_to','ftsarms_to',...
                'joint_path','acc_path','imu_path','fts_path','jtorq_path','ftsarms_path'};
            portNamingRule = {...
                ...
                eval(['@(robotname,part)' joints_port_rule_icub]),...
                eval(['@(robotname,part)' FTSensorsArms_port_rule_icub]),...
                ...
                eval(['@(robotname,part)' joints_port_rule_dumper]),...
                eval(['@(robotname,part)' FTSensorsArms_port_rule_dumper]),...
                ...
                eval(['@(datapath,part)' joints_folder_rule_dumper]),...                
                eval(['@(datapath,part)' FTSensorsArms_folder_rule_dumper])};
